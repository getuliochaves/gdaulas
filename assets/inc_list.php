...
<div class="form-group">
    <label for="inputText" class="col-sm-5 control-label">Escolha a Página que Deseja Modificar:</label>
    <div class="col-sm-7">
     <?php
    ...
    'post_type' => 'page'));
	 ?>
       <a class="btn btn-primary btn-lg" style="margin-top:5px;" href="#" id="linkaddaulas">Gerenciar Aulas desta Página</a>
    </div>
  </div>
</div>
<script>
